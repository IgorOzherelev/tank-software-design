...
public class TankMoveTest {
    ...
    public void test001_TankMoveTest_Right() {
        ...
        tank.move(1);
        Assertions.assertEquals(tank.getCurrentCoordinates(), new Point(4, 5));
    ...
    public void test002_TankMoveTest_Left() {
        ...
        tank.move(1);
        Assertions.assertEquals(tank.getCurrentCoordinates(), new Point(2, 5));
        Assertions.assertEquals(tank.getMovementProgress(), 1f);
    ...
    public void test003_TankMoveTest_Up() {
        ...
        tank.move(1);
        Assertions.assertEquals(tank.getCurrentCoordinates(), new Point(3, 6));
        Assertions.assertEquals(tank.getMovementProgress(), 1f);
    ...
    public void test004_TankMoveTest_Down() {
        ...
        tank.move(1);
        Assertions.assertEquals(tank.getCurrentCoordinates(), new Point(3, 4));
        Assertions.assertEquals(tank.getMovementProgress(), 1f);
